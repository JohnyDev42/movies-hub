...
const Footer = ()=>{
    return(
        <div>
        <footer className="bg-indigo-900 text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
            <a href="/" className="grid justify-center mr-4 w-1/3">
                <h1 className="font-serif  text-2xl text-red-600">MovieTorrent</h1>
            ...
            <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
                ...
                <div className="text-gray-700 flex flex-col w-full pt-1 ">
                    <div className=" flex text-white uppercase font-medium  tracking-wide">Follow ME</div>
        ...
        <div className=" mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center"> © 2020 MovieTorrent. All rights reserved.</div>
    </footer>
    </div>
    )
}
